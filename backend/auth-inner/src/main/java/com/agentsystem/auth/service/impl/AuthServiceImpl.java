...
public class AuthServiceImpl implements AuthService {
    ...
    public void requestOtp(String email) {
        ...
        if (userAccountService.findActiveUser(normalised).isEmpty()) {
            AuthUser existing = userAccountService.findByEmail(normalised).orElse(null);
            if (existing != null && "PRE_USER".equals(existing.getStatus())) {
    ...
    public String verifyOtp(String email, String code, String mode, String orgId) {
        ...
        if ("TEAM".equals(mode)) {
            ...
            if (!orgLookupService.isMember(orgId.trim(), normalised)) {
        ...
        AuthUser user = userAccountService.findActiveUser(normalised)
    ...
    public String verifyRegistrationOtp(String email, String code) {
        ...
        AuthUser user = userAccountService.registerOrGetPending(normalised);
    ...
    private void sendOtp(String keyPrefix, String attemptsPrefix, String normalisedEmail) {
        ...
        // by agent-system-rest's RateLimitFilter OTP/REGISTER_OTP buckets).
