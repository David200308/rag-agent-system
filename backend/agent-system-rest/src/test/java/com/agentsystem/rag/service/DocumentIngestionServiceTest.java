...
import com.agentsystem.rag.service.impl.DocumentIngestionServiceImpl;
...
class DocumentIngestionServiceTest {
    ...
    DocumentIngestionServiceImpl service;

    @BeforeEach
    void setUp() {
        service = new DocumentIngestionServiceImpl(vectorStore);
